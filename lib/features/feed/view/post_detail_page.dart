...
import 'package:pet_connect_ai/app/theme/app_icons.dart';
...
class _PostDetailPageState extends ConsumerState<PostDetailPage> {
  ...
  Widget build(BuildContext context) {
    final p = _post;
    print(
      "Avatar URL: ${p != null ? _avatarUrl(p.avatarUrl) : 'No post loaded'}",
    );
    return Scaffold(
...
class _PostHeader extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final avatar = _avatarUrl(p.avatarUrl);
            ...
            child: AspectRatio(
              ...
              child: PageView.builder(
                ...
                itemBuilder: (_, i) => Image.network(
                  AppConfig.baseStorage + p.images[i],
                  fit: BoxFit.cover,
                ),
              ),
            ),
        ...
        InkWell(
          ...
          child: Padding(
            ...
            child: SvgPicture.asset(
              p.isLiked ? AppIcons.icHeartActive : AppIcons.icHeart,
              width: 22,
              height: 22,
...
class _CommentTile extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final avatar = _avatarUrl(c.avatarUrl);
    print("Avatar URL for comment: ${avatar ?? 'No avatar'}");
